...
namespace _7DaysToCheat {
    ...
    internal class HelperFunctions {
        ...
        public static void Set_Collection_Of_Constants() {
            //Set Constants
            Constants.cDigAndBuildDistance = 500f;
            Constants.cBuildIntervall = 0.2f;
            Constants.cCollectItemDistance = 500f;
            Constants.cSneakDamageMultiplier = 99f;
            Constants.cCollectItemDistance = 99f;
            Constants.cMaxEntitiesPerMobSpawner = 15;
            Constants.cRandomSpawnPointsToPlace = 8;
            Constants.cMaxPlayerFood = 500;
            Constants.cMaxPlayerDrink = 500;
            //Set GameStats
            GameStats.Set(EnumGameStats.AirDropFrequency, 1);
            GameStats.Set(EnumGameStats.AnimalCount, 99);
            GameStats.Set(EnumGameStats.BloodMoonEnemyCount, 99);
            GameStats.Set(EnumGameStats.EnemyCount, 99);
